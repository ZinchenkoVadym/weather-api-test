                ...
                <div className='current-weather__block'>
                    ...
                    <div className='temperature__block'>
                        ...
                        {props.loaderFahrenheit
                            ? <div className='temp'><TailSpin color='rgba(15,58,83,0.62)'/></div>
                        ...
                        <div className='celsius'>
                            <button
                                ...
                                onClick={() => props.getFahrenheitTemp(props.cityData.name)}> &deg;F</button>
                            <button
                                className={`${props.toggleTempBool ? '' : 'active'}`}
                                onClick={() => props.toggleTemp(false)}> &deg;C</button>
                        </div>
                    </div>
                    ...
                    <div className='weather__parametrs'>
                        ...
                        <div>Temperature: {Math.round(props.weatherData[0].main.temp)} &deg;C</div>
                        <div>Feels-like: {Math.round(props.weatherData[0].main.feels_like)} &deg;C</div>
